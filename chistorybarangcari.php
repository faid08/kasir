...
WHERE tbstock.idtoko='$idtoko' AND tbharga.idtoko='$idtoko' AND tbbarang.nama_barang LIKE '%$namabr%' or tbbarang.barcode LIKE '%$namabr%' GROUP BY tbstock.idbarang");
