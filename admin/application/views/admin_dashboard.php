...
<html lang="en">
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <link rel="stylesheet" href="<?= site_url(); ?>vendor/plugins/jquery-ui/jquery-ui.css">        
                ...
                <div class="sidebar">
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            ...
                            <a href="#" class="d-block"><?= '<b>'.$lvl . '</b> ' . $nama_toko ?></a>
                        </div>
                    </div>
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column  nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
							...
							<?php
                                    if (($this->session->userdata['logged_in']['level']) == "Admin") {
                                        ?>
                                        <li class="nav-item">
											<a href="#" class="nav-link " onclick="pengajuan_barang()">
												<i class="nav-icon fas fa-envelope"></i>
												<p>Pengajuan Stock Barang</p>
											</a>
										</li>
                                        <?php
                                    }
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item" onclick="toko()">
                                        <a href="#" class="nav-link">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="#" class="nav-link" onclick="pindah_stock()">
                                            <i class="far fa-circle nav-icon text-primary"></i>
                                            <p>Pindah Stock</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link"onclick="pengeluaran()">
                                    <i class="nav-icon fas fa-copy"></i>
                                    <p>
                                        Pengeluaran
                                    </p>
                            ...
                            <li class="nav-item has-treeview ">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link"onclick="piutang_suplayer()">
                                            <i class="far fa-circle nav-icon text-primary"></i>
                                            <p> Piutang Suplayer</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link"onclick="neraca()">
                                            <i class="far fa-circle nav-icon text-primary"></i>
                                            <p>Neraca</p>
                                        </a>
                                    </li>
                           ...
                           <!--  <li class="nav-item has-treeview ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="#" class="nav-link"onclick="histori_barang()">
                                            <i class="far fa-circle nav-icon text-primary"></i>
                                            <p> Bistori Barang</p>
                                        </a>
                                    </li>                                
                            ...
                            if (($this->session->userdata['logged_in']['level']) == "Admin") {
                                ?>
<!--                                <li class="nav-item">
                                    <a href="#" class="nav-link " onclick="grafik()">
    ...
    <script type="text/javascript">
									...
									function pengajuan_barang() {
                                        $.post('Pengajuan-barang', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">Master / <small> Entri Barang</small></a>');
                                            remove_add_class();
                                        });
                                    ...
                                    function toko() {
                                        $.post('Toko', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">Master / <small> Entri Toko</small></a>');
                                            remove_add_class();
                                        });
                                    }
                                    function pindah_stock() {
                                        $.post('Pindah-Stock', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">Transaksi / <small> Pindah Stock </small></a>');
                                            remove_add_class();
                                        });
                                    }
                                    ...
                                    function pengeluaran() {
                                        $.post('Pengeluaran', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">Pengeluaran </a>');
                                            remove_add_class();
                                        });
                                    }
                                    ...
                                    function piutang_suplayer() {
                                        $.post('Piutang-Suplayer', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">Laporan / <small> Piutang Suplayer </small></a>');
                                            remove_add_class();
                                        });
                                    }
                                    function omset() {
                                    ...
                                    function neraca() {
                                        $.post('Neraca', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">Neraca </a>');
                                            remove_add_class();
                                        });
                                    }
                                    function histori_barang() {
                                        $.post('Histori-Barang', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">HIstory / <small> histori barang</small></a>');
                                            remove_add_class();
                                        });
                                    }
                                    function grafik() {
                                        $.post('Grafik', function (Res) {
                                            $('.content').html(Res);
                                            $('#nama_link').html('<a href="#" class="nav-link">Grafik</a>');
                                            remove_add_class();
                                        });
                                    }
