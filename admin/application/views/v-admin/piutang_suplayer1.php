<div class="container-fluid">
                    ...
                    <div class="card-title">
                        <div class="row ">
                            ...
                            <div class=" input-group input-group-sm col-lg-6" >
                                <input type="text" name="search_piutang_suplayer" id="search_piutang_suplayer" class="form-control float-right" placeholder="Nota atau Nama suplayer">
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-danger"  onclick="laporan_piutang_suplayer()"><i class="fas fa-search"></i></button>
                                </div>
                            </div>                            
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-5" id="row_piutang_suplayer_edit">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p id="suplayerhistory">-</p>
                                <p id="marketinghistory">-</p>                                
                            </div>
                            <div class="col-md-4">
                                <p id="hp_suplayerhistory">-</p> 
...
<script>
    $(function () {
        $('#search_piutang_suplayer').focus();
         $('#interval_tanggal').daterangepicker();
         laporan_piutang_suplayer();
         $("#search_piutang_suplayer").keypress(function (e) {
    ...
    function laporan_piutang_suplayer() {
     var tgl = $('#interval_tanggal').val();
        $.ajax({
            url: "<?= site_url('Admin_laporan/laporan_piutang_suplayer') ?>",
            type: 'POST',
            data: {search_nm: $('#search_piutang_suplayer').val(),tgl:tgl, pilihtoko:$('#pilihtoko').val()},
            dataType: 'JSON',
            success: function (data) {
                if (data.sukses === 'ya') {
                    $('#list_hutangsuplayer').html('`' + data.list_hutang_suplayer + '`');
    ...
    function info_nota(nota) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#suplayer').html('Nama suplayer&nbsp;&nbsp;:&nbsp;'+data.penjualan.nama_c);
                $('#hp_suplayer').html('HP suplayer&nbsp;&nbsp;:&nbsp; '+data.penjualan.hp_c);
    ...
    function historypiutang_nota(nota) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#suplayerhistory').html('Nama suplayer&nbsp;&nbsp;:&nbsp;'+data.penjualanhistory.nama_c);
                $('#hp_suplayerhistory').html('HP suplayer&nbsp;&nbsp;:&nbsp; '+data.penjualanhistory.hp_c);
    ...
    function form_edit_piutang_suplayer(id) {
        $.post('<?= site_url('Admin_dashboard/form_edit_piutang_suplayer')?>', {id: id,pilihtoko:$('#pilihtoko').val()}, function (Res) {
            $('#row_tabel_hutang').removeClass('col-md-12');
            $('#row_tabel_hutang').addClass('col-md-7');
            $('#row_piutang_suplayer_edit').html(Res);
        });
    }
    function cancel_form() {
        $('#row_piutang_suplayer_edit').html('');
