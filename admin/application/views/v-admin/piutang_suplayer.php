<div class="container-fluid">
                    ...
                    <div class="card-title">
                        <div class="row ">
                            ...
                            <div class=" input-group input-group-sm col-lg-6" >
                                <input type="text" name="search_piutang_customer" id="search_piutang_customer" class="form-control float-right" placeholder="Nota atau Nama Suplayer">
    ...
    <div class="row">
        ...
        <div class="col-md-5" id="row_piutang_customer_edit1">
...
<script>
    ...
    function laporan_piutang_suplayer() {
     var tgl = $('#interval_tanggal').val();
        $.ajax({
            url: "<?= site_url('Admin_laporan/laporan_piutang_suplayer1') ?>",
            type: 'POST',
    ...
    function info_nota(nota) {
        ...
        $.ajax({
            url: "<?= site_url('Admin_laporan/info_nota_suplayer') ?>",
            type: 'POST',
            ...
            success: function (data) {
                ...
                $('#customer').html('Nama Suplayer&nbsp;&nbsp;:&nbsp;'+data.penjualan.nama_c);
    ...
    function historypiutang_nota(nota) {
        $('.modal-title').html(nota);
        $.ajax({
            url: "<?= site_url('Admin_laporan/infohistory_nota_suplayer') ?>",
            type: 'POST',
            data: {nota: nota,pilihtoko:$('#pilihtoko').val()},
            dataType: 'JSON',
            success: function (data) {
                ...
                $('#tgl_transaksi').html('Tanggal&nbsp;:&nbsp;'+data.penjualan.tanggal);
                $('#customer').html('Nama Suplayer&nbsp;&nbsp;:&nbsp;'+data.penjualan.nama_c);
                $('#detail_data').html('`' + data.detail_penjualanhistory + '`');
    ...
    function historypiutang_nota1(nota) {
    ...
    function form_edit_piutang_suplayer(id) {
        $.post('<?= site_url('Admin_dashboard/form_edit_piutang_suplayer')?>', {id: id,pilihtoko:$('#pilihtoko').val()}, function (Res) {
            ...
            $('#row_piutang_customer_edit1').html(Res);
        });
    }
    function cancel_form() {
        $('#row_piutang_customer_edit1').html('');
