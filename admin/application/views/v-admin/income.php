                ...
                <div class="card-header">
                    <div class="card-title">
                        <div class="row ">
                            ...
                            <div class=" input-group input-group-sm col-lg-6" >
                                <input type="text" name="search_income" id="search_income" class="form-control float-right" placeholder="Cari">
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success"  onclick="laporan_income()"><i class="fas fa-search"></i></button>
                                    </div>
                            </div>                            
                        </div>
                    </div>
                    <div class="card-tools">                        
                        <ul class="nav nav-pills ml-auto form-inline">                            
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" ><i class="fa fa-copy"></i> Export Data Income</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tfoot >                        
                            <tr >
                                ...
                                <td colspan="8" style="text-align: right">Jumlah Income &nbsp;&nbsp;=&nbsp;&nbsp;&nbsp;&nbsp;<label id="jum_income" class="text-green" style="font-size: 25px;">(-)</label></td>
                            </tr>
                        </tfoot>                        
                    </table>
                </div>
...
<script>
    ...
    function laporan_income() {
        ...
        $.ajax({
            url: "<?= site_url('Admin_laporan/laporan_income') ?>",
            type: 'POST',
            data: {search_income: $('#search_income').val(), tgl: tgl, pilihtoko: $('#pilihtoko').val(),baris: $('#baris').val()},
            dataType: 'JSON',
            success: function (data) {
                if (data.sukses === 'ya') {
                    $('#list_income').html('`' + data.list_income + '`');
                    $('#jum_income').html(data.jum_income);
                } else {
                    $('#list_income').html('`' + data.list_income + '`');
                    $('#jum_income').html(data.jum_income);
                }
