                ...
                <div class="card-body table-responsive p-0 ">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody id="list_data_nota_pending">
                            ...
                            <tr>
                                <td colspan="9">
                                    &CircleTimes; Silahkan tampilkan Transaksi penjualan Pending berdasarkan <b>Nota pending</b> atau <b>Nama customer</b> dengan klik <button type="submit" class="btn btn-info btn-sm"><i class="fas fa-search"></i></button><br> 
...
<script type="text/javascript">
    ...
    function form_edit_nota_pending(nota) {
        $.post('<?= site_url('Admin_dashboard/form_edit_nota_pending') ?>', {nota: nota,pilihtoko:$('#pilihtoko').val()}, function (Res) {
            $('.content').html(Res);
            $('#nama_link').html('<a href="#" class="nav-link">Edit Nota Pending</a>');
        });
    }
</script>