<div class="card card-danger">
    <div class="card-header">
        <h3 class="card-title">Edit Piutang Suplayer </h3>
    </div>
    <div class="card-body p-0">
        <form class="form-horizontal" id="row_piutang_customer_edit1">
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" class=" form-control form-control-sm" id="idsuplayer" name="idsuplayer" 
                        value="<?= $idsuplayer ?>" hidden>
                    </div>
                </div>
                <div class="form-group row">
                    <small class="col-sm-12 text-danger">Detail Data Piutang Suplayer</small>
                </div> 
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-sm-5 "style="font-family: serif">Total belanja </label>
                    <label class="col-sm-7 "style="font-family: serif">
                    &nbsp;<?= 'Rp ' . number_format($totalbayar, 0, '.', '.') ?> &nbsp;</label>
                </div> 
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-7 text-danger"style="font-family: serif">=&nbsp;<?= 'Rp ' . number_format(($bayar - ($totalbayar)), 0, '.', '.') ?></label>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input type="hidden" class=" form-control form-control-sm" id="tot_hutang" name="tot_hutang" value="<?=$totalbayar ?>" >
        ...
        <div class="card-footer p-1">
            <button type="submit" class="btn btn-danger" onclick="update_data_piutang()">Edit Pembayaran</button>
...
<script>
    ...
    function update_data_piutang() {
        var nota = $('#nota').val();
        $.ajax({
            url: '<?php echo site_url('Admin_laporan/update_data_piutang_suplayer') ?>',
            type: 'POST',
            data: {tot: $('#tot_hutang').val(), bayar: $('#bayar').val(), bayar_sebelumnya: $('#pembayaran_sebelumnya').val(), nota: nota, idcustomer: $('#idsuplayer').val()},
            dataType: "JSON",
