                    ...
                    <div class="card-title">
                        <div class="row ">
                            ...
                            <div class=" input-group input-group-sm col-lg-6" >
                                <input type="text" name="search_omset" id="search_omset" class="form-control float-right" placeholder="Cari">
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-warning"  onclick="laporan_omset()"><i class="fas fa-search"></i></button>
                                </div>
                            </div>                            
                        </div>
                    </div>
                    ...
                    <table class="table table-hover text-nowrap">
                        <thead >
                            <tr>
                                ...
                                <th >Nama Customer</th>                              
                                <th >Omset</th>
                                <th class="bg bg-warning">Print</th>
                                <th class="bg bg-warning">Info</th>
                            </tr>
                        </thead>
                        <tbody id="list_omset">   
                        ...
                        <tfoot >                        
                            <tr >
                                ...
                                <td colspan="5"style="text-align: right">Jumlah Oset &nbsp;&nbsp;=&nbsp;&nbsp;&nbsp;&nbsp;<label id="jum_omset" class="text-warning" style="font-size: 25px;">(-)</label></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<script>
    ...
    function laporan_omset() {
        ...
        $.ajax({
            url: "<?= site_url('Admin_laporan/laporan_omset') ?>",
            type: 'POST',
            data: {search_omset: $('#search_omset').val(), tgl: tgl, pilihtoko: $('#pilihtoko').val(), baris: $('#baris').val()},
            dataType: 'JSON',
