    ...
    <div class="content">
        <div class="container">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">                                    
                                    <input type="text" class="form-control form-control-sm text-bold" name="nota" value="<?= $penjualan->notatransaksi_penjualan_customer ?>" readonly>
                                </div>
                            </div>                                        
                    ...
                    <div class="card card-danger card-outline">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">                                    
                                    <textarea rows="2" class="form-control form-control-sm no-resize" placeholder="Alamat Customer" name="alamat" id="alamat"  <?= $disab ?>><?= $penjualan->alamat_customer ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-10">                                    
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label for="tombol_prngiriman" class="custom-control-label" id="keterangan_aktif">Pengiriman <span class="text-danger"><?= $ket ?></span></label>
                ...
                <div class="col-lg-9">
                    <div class="card card-red card-outline" style="margin-bottom:6px;">
                        <div class="body" style="padding:15px 25px;height:425px;overflow:auto;">
